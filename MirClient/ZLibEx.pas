...
function zlibAllocMem(AppData: Pointer; Items, Size: Integer): Pointer; {$IFDEF LINUX} cdecl; {$ENDIF}
procedure zlibFreeMem(AppData, Block: Pointer); {$IFDEF LINUX} cdecl; {$ENDIF}
function deflateInit_(var strm: TZStreamRec; level: Integer; version: PChar;
  recsize: Integer): Integer; {$IFDEF LINUX} cdecl; {$ENDIF}
function deflate(var strm: TZStreamRec; flush: Integer): Integer; {$IFDEF LINUX} cdecl; {$ENDIF}
function deflateEnd(var strm: TZStreamRec): Integer; {$IFDEF LINUX} cdecl; {$ENDIF}
function inflateInit_(var strm: TZStreamRec; version: PChar;
  recsize: Integer): Integer; {$IFDEF LINUX} cdecl; {$ENDIF}
function inflate(var strm: TZStreamRec; flush: Integer): Integer; {$IFDEF LINUX} cdecl; {$ENDIF}
function inflateEnd(var strm: TZStreamRec): Integer; {$IFDEF LINUX} cdecl; {$ENDIF}
function inflateReset(var strm: TZStreamRec): Integer; {$IFDEF LINUX} cdecl; {$ENDIF}
